...
import { RoleBadge, StatusBadge } from "@/containers/hr/employee-management/CreateEmployee";
    ...
    <>
      ...
      <div className=" py-6 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between">
          <Button variant="outline" size="sm" onClick={() => router.push("/hr/employee-management")} className="gap-2">
          ...
          {isAdminOrHr  && (
            <Button
              size="sm"
              className="gap-2"
              onClick={() => router.push(`/hr/employee-management/update-employee/${id}`)}
            >
