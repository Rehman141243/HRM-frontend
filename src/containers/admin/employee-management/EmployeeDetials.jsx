...
import { RoleBadge, StatusBadge } from "@/containers/admin/employee-management/CreateEmployee";
    ...
    <>
      ...
      <div className=" py-6 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between">
          <Button variant="outline" size="sm" onClick={() => router.push("/admin/employee-management")} className="gap-2">
          ...
          {isAdminOrHr && (
            <Button
              size="sm"
              className="gap-2"
              onClick={() => router.push(`/admin/employee-management/update-employee/${id}`)}
            >
