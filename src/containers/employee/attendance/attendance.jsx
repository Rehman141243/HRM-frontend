						...
						<div className="bg-slate-100 dark:bg-gradient-to-r dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
							<div className="grid gap-5 p-4 sm:p-5 lg:p-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:items-stretch">
								...
								<div className="flex h-full flex-col justify-between gap-4">
									...
									{/* Stats grid */}
									<div className="grid gap-3 rounded-2xl border border-slate-200 bg-gray-50 p-3 sm:p-4 sm:grid-cols-3 dark:border-white/10 dark:bg-white/5">
										<div>
								...
								<div className="flex h-full flex-col justify-between gap-3 rounded-2xl border border-slate-200 bg-gray-50 p-4 sm:p-5 dark:border-white/10 dark:bg-white/5 dark:backdrop-blur-sm">
