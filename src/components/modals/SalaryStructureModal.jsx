        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { label: "Attendance", val: s.attendance_policy?.name || null },
                { label: "Overtime",   val: s.overtime_policy?.name   || null },
                { label: "Tax",        val: s.tax_policy?.name         || null },
                { label: "Bonus",      val: s.bonus_policy?.name       || null },
              ].map(({ label, val }) => (
